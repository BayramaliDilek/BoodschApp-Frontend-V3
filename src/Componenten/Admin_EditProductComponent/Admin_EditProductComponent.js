            ...
            {user.roles !== "ROLE_ADMIN" ?
                ...
                <div className="Product-Form-Container">
                    ...
                    <div className="admin-product-text">
                        ...
                        <br/>
                        Voor bestaande producten vult u het bestaande artikelnummer in om een bestaand product te
                        wijzigen.
                        <br/>
                        Voor de prijs gebruikt u een 'punt' i.p.v een 'komma' om decimale getallen in te voeren.
                        bijvoorbeeld: € 2.19
                        <br/>
                        Het opslaan/wijzigen van een product zal alleen lukken als er een artikelnummer, product-naam en
                        prijs zijn ingevuld.
